...
Daily tech-watch digest built with **n8n + Claude**, published to GitHub Pages,
announced on Discord. A hands-on n8n learning project, developed spec-first with
Claude Code.

**Live digest:** https://\<user\>.github.io/n8n-watch-dummy/ *(update after enabling Pages)*

## How it works

Every day at 09:30 (Europe/Paris), n8n fetches several RSS tech sources, asks Claude to
...
Credentials (Anthropic, GitHub PAT, Discord webhook) are created in the n8n UI — see
